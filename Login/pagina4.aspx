<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pagina4.aspx.cs" Inherits="Login.WebForm4" EnableSessionState="true"%>

<!DOCTYPE html>

<html">
<head runat="server">
    <title>Login - Página 4</title>
...
<body>
    ...
    <div class="pagina">
            <ul id="menu" class="menu">
                ...
                <li class="seleccionado"><a href="pagina4.aspx">Página 4</a></li>
