<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pagina5.aspx.cs" Inherits="Login.WebForm5" EnableSessionState="true" %>

<!DOCTYPE html>

<html>
<head runat="server">
    <title>Login - Página 5</title>
...
<body>
    ...
    <div class="pagina">
        <ul id="menu" class="menu">
            ...
            <li class="seleccionado"><a href="pagina5.aspx">Página 5</a></li>
        </ul>
        <div class="contenido">
            <br />
