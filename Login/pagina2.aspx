<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pagina2.aspx.cs" Inherits="Login.WebForm2" EnableSessionState="true" %>

<!DOCTYPE html>

<html>
<head runat="server">
    <title>Login - Página 2</title>
...
<body>
    ...
    <div class="pagina">
        <ul id="menu" class="menu">
            ...
            <li class="seleccionado"><a href="pagina2.aspx">Página 2</a></li>
